...
from transformer.modeling import BertForSequenceClassification, TinyBertForSequenceClassification, BertForMaskedLM
...
def parse_arguments():
    ...
    parser.add_argument('--model', help='which BERT model to use', required=True)
